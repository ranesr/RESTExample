package com.ranesaurabh.webservices.client;
...
public class ConversionServiceClient {  
    ...
    static final String INCH_TO_FEET = "/convert/InchToFeet/";  
    static final String FEET_TO_INCH = "/convert/FeetToInch/";  
    ...
    public static void main(String[] args) {  
        ...
        WebResource addService = service.path("services").path(INCH_TO_FEET+inch);  
        ...
        WebResource subService = service.path("services").path(FEET_TO_INCH+feet);  
